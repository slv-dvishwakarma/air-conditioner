        ...
        <ParentContainer className='bg-[#0F2C49] py-5'>
            <GridBox columns={2} gap={10} className='items-center xl:space-y-0 lg:space-y-0 md:space-y-0 space-y-5'>
                <GridBox.GridItem columnMerge={1} >
                    <Link href={data.map_link} target='_blank' className='flex items-center gap-2.5 text-white text-base group hover:text-[#FF5500]'><SVGIcon className="text-white group-hover:text-[#FF5500] text-xl w-[35px] h-[35px] flex items-center justify-center border rounded-[50%] border-solid border-white group-hover:border-[#FF5500]" name="map" /> {data.address}</Link>
                </GridBox.GridItem>
                <GridBox.GridItem columnMerge={1} >
