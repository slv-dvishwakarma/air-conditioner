...
export const POST = async (req: Request) => {
  ...
  try {
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        user: "github7878@gmail.com", // Your Gmail address
        pass: "Dilip@7878", // Your Gmail password
      },
      tls: {
    ...
    const info = await transporter.sendMail({
      from: "github7878@gmail.com", // Sender address
      to: 'github7878@gmail.com', // List of receivers
